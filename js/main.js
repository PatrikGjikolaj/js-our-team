...
for (let i = 0; i < team.length; i++) {
    document.getElementById("nome").innerText = team[i].nome;
    document.getElementById("ruolo").innerText = team[i].ruolo;
    document.getElementById("foto").innerText = team[i].foto;
}
